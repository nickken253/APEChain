...
export const ConnectWallet = (props: IConnectWalletProps) => {
    return (
        <div className='bg-[#131313] w-[95%] sm:px-5 sm:w-[70%] md:w-[55%] lg:w-[45%] xl:px-10 xl:w-[35%] rounded-lg p-5 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/3 flex flex-col justify-center items-center z-100 '>
            ...
            <div className='px-3 sm:px-24 text-sm text-center'>Buy connecting a wallet, you agree to Apechain Terms of Service and consent to its Privacy Policy.</div>
        </div>
    )
}
